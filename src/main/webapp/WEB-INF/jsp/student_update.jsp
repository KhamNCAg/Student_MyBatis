...
<jsp:include page="/WEB-INF/layout/nav.jsp"/>
    ...
    <div id="sub_content">
        <form:form action="/student_registration_with_spring_n_mybatis/update_student" method="post" modelAttribute="stu">
    				...
    				<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <a href="/student_registration_with_spring_n_mybatis/delete_student/${stu.id}"><button type="button" class="btn btn-secondary" >Ok</button></a>
